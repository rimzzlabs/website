export const HomeHeroDescription = () => (
  <div className='mt-4 [&>p:not(:last-child)]:mb-3 [&>p]:max-w-prose md:pb-6'>
    <p>
      I am Rizki, and I am a <strong>frontend developer</strong>. I am passionate about{' '}
      <strong>front-end development</strong> and enjoy working on web development. I love combining
      my technical skills with my creativity to develop{' '}
      <strong>fun and user-friendly websites</strong> and applications.
    </p>
    <p>
    ...
    <p>
      ...
      hit me up if you have any suggestions to improve anything that is required for this website to
      be more pleasant for everyone to enjoy.
    </p>
  </div>
)
