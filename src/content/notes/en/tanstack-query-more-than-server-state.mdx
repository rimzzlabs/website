...
<NoteImage
  ...
  caption="How a system works in general"
/>
...
<NoteImage
  ...
  caption="The role of Tanstack Query in a frontend application."
/>
...
<NoteImage
  ...
  caption="queryFn quietly reads values from the closure, while Tanstack Query only reads the label (queryKey)."
/>
...
<NoteImage lang="en" src={DuplicateRequest} alt="Duplicated requests" caption="Duplicated requests." />
