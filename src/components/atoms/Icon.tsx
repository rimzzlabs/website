...
const Icon = ({ type, className = '' }: IconType) => {
  switch (type) {
    case 'markdown':
      return (
        <I.SiMarkdown
          className={`text-gray-900 dark:text-gray-400 ${className}`}
        />
      )
    case 'html':
      return (
    ...
    case 'css':
      return (
        <I.SiCss3 className={`text-blue-500 dark:text-blue-400 ${className}`} />
      )
    case 'sass':
    case 'scss':
      return (
        <I.SiSass className={`text-pink-500 dark:text-pink-400 ${className}`} />
      )
    ...
    case 'tailwindcss':
      return (
        <I.SiTailwindcss
          className={`text-sky-500 dark:text-sky-400 ${className}`}
        />
      )
    case 'javascript':
    case 'js':
    ...
    case 'react':
      return (
        <I.SiReact className={`text-sky-500 dark:text-sky-400 ${className}`} />
      )
    case 'nextjs':
    case 'next':
      return (
    ...
    case 'express':
      return (
        <I.SiExpress
          className={`text-typo-800 dark:text-typo-400 ${className}`}
        />
      )
    case 'mongodb':
      return (
    ...
    case 'github':
      return (
        <I.SiGithub
          className={`text-gray-800 dark:text-gray-400 ${className}`}
        />
      )
    ...
    case 'php':
      return (
        <I.SiPhp className={`text-blue-500 dark:text-blue-400 ${className}`} />
      )
