...
featured: true
image: 'https://images.unsplash.com/photo-1609266378844-4a8af6d72fab?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80'
...
2021 is a year where I feel like everything is no longer _normal_, but everything in my perspective is just _fast_.
...
Soon it would be end of February, I'm still following the tutorial without a direction, where I learned the basics of HTML at <ArticleLink href="https://w3schools.com/" newTab>W3 Schools</ArticleLink> and without a mentor or even roadmap, I'm totally blind there, even then I was having a really hard time creating a _Hidden Nav Menu_ LOL😂.
...
After about 2 Months of being a **lost sheep**, I also found a very cool YouTube channel, <ArticleLink href="https://youtube.com/c/WebProgrammingUNPAS" newTab>Web Programming UNPAS</ArticleLink>. On that YouTube channel I learned a lot, there is a playlist for Frontend Developers too, so I started again from scratch, I also followed the roadmap Frontend Developer on <ArticleLink href="https://roadmap.sh/" newTab>Rodmap</ArticleLink>, starting with HTML, CSS and Javascript.
...
1. <ArticleLink href='https://www.dicoding.com/academies/123' newTab>
     Belajar Dasar Pemrograman Web
   </ArticleLink>
2. <ArticleLink href='https://www.dicoding.com/academies/315' newTab>
     Belajar Membuat Frontend Untuk Web Untuk Pemula
   </ArticleLink>
3. <ArticleLink href='https://www.dicoding.com/academies/163' newTab>
     Belajar Fundamental Frontend Web Development
   </ArticleLink>
...
Then in August, I tried to learn <ArticleLink href="https://nextjs.org" mewTab >NEXT.js</ArticleLink>, a framework built on top of React, it has many features such as built-in routing, and file-based routing.

Now I'm more comfortable with NEXT.js, an then on October, I learned TypeScript, and I feel so comfortable with NEXT.js + TypeSCript.
...
Then I took part in the Frontend Challenge event held by <ArticleLink href="https://skyshi.com" newTab>Skyshi</ArticleLink> and <ArticleLink href="https://blog.gethired.id/devcode/" newTab>GetHired DevCode</ArticleLink>.

A very exciting event, and there was so many people participated in this event, we were required to create a <ArticleLink href="https://developer.mozilla.org/en-US/docs/Glossary/SPA" newTab>SPA-Based</ArticleLink> Web Application that focuses on performance.
