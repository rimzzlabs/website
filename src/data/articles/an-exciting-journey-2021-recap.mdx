...
Soon it would be end of February, I'm still following the tutorial without a direction, where I learned the basics of HTML at <UnderlineLink href="https://w3schools.com/" newTab>W3 Schools</UnderlineLink> and without a mentor or even roadmap, I'm totally blind there, even then I was having a really hard time creating a _Hidden Nav Menu_ LOL😂.
...
After about 2 Months of being a **lost sheep**, I also found a very cool YouTube channel, <UnderlineLink href="https://youtube.com/c/WebProgrammingUNPAS" newTab>Web Programming UNPAS</UnderlineLink>. On that YouTube channel I learned a lot, there is a playlist for Frontend Developers too, so I started again from scratch, I also followed the Frontend Developer roadmap based on <UnderlineLink href="https://roadmap.sh/" newTab>Roadmap.sh</UnderlineLink>, starting with HTML, CSS and Javascript.
...
1. <UnderlineLink href='https://www.dicoding.com/academies/123' newTab>
     Belajar Dasar Pemrograman Web
   </UnderlineLink>
2. <UnderlineLink href='https://www.dicoding.com/academies/315' newTab>
     Belajar Membuat Frontend Untuk Web Untuk Pemula
   </UnderlineLink>
3. <UnderlineLink href='https://www.dicoding.com/academies/163' newTab>
...
Then in August, I tried to learn <UnderlineLink href="https://nextjs.org" mewTab >NEXT.js</UnderlineLink>, a framework built on top of React, it has many features such as built-in routing, and file-based routing.
...
Then I took part in the Frontend Challenge event held by <UnderlineLink href="https://skyshi.com" newTab>Skyshi</UnderlineLink> and <UnderlineLink href="https://blog.gethired.id/devcode/" newTab>GetHired DevCode</UnderlineLink>.

A very exciting event, and there was so many people participated in this event, we were required to create a <UnderlineLink href="https://developer.mozilla.org/en-US/docs/Glossary/SPA" newTab>SPA-Based</UnderlineLink> Web Application that focuses on performance.
