...
If you work with animation, and are comfortable with <UnderlineLink href="https://framer.com/motion/" newTab>Framer Motion</UnderlineLink> you can use this hook to animate element when it is in viewport.
