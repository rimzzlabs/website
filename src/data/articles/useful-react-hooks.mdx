...
If you work with animation, and are comfortable with <ArticleLink href="https://framer.com/motion/" newTab>Framer Motion</ArticleLink> you can use this hook to animate element when it is in viewport.
