...
export const en = {
	...
	nav: {
		...
		connect: { trigger: "Get in touch", scheduleCall: "Schedule a call", sendEmail: "Send email" },
	},

	contact: {
		title: "Send me an email",
		description:
			"Prefer async? Drop me a message and I'll get back to you. I only need a real email so I can reply.",
		nameLabel: "Name",
		namePlaceholder: "Budi Perkasa",
		emailLabel: "Email",
		emailPlaceholder: "budi@acme.com",
		subjectLabel: "Subject",
		subjectPlaceholder: "e.g: Role Opportunities",
		messageLabel: "Message",
		messagePlaceholder: "Hi Rizki, I'd like to talk about opportunity...",
		toolbar: {
			bold: "Bold",
			italic: "Italic",
		...
		successBody: "Thanks for reaching out. I'll reply to your email soon.",
		errorTitle: "Something went wrong",
		errorBody: "Your message couldn't be sent. Please try again in a moment.",
		validation: {
			name: "Enter your name",
			nameMax: "Max {max} characters",
			email: "Enter a valid email",
			emailMax: "Max {max} characters",
			subject: "Enter a subject",
			subjectMax: "Max {max} characters",
			message: "Write your message",
			token: "Complete the verification below",
		},
	},
	...
	guestbook: {
		...
		openGuestbook: "See all messages",
		write: "Write a message",
		empty: {
			title: "No one here yet",
			description: "Be the first one to write a message!",
		},
		dialog: {
			title: "Write something about this site",
			description: "Leave a review, comment or just say hi.",
		},
		nameLabel: "Name",
		namePlaceholder: "John doe",
		siteLabel: "Site (optional)",
		sitePlaceholder: "johndoe.com",
		messageLabel: "Message",
		messagePlaceholder: "e.g: Cool! Checkout my site!",
		send: "Send message",
		sending: "Sending…",
		close: "Close",
		edit: "Edit",
		...
		deleteDescription: "This permanently removes your message and can't be undone.",
		deleteConfirm: "Delete",
		deleting: "Deleting…",
		cancel: "Cancel",
		continueGithub: "Continue with GitHub",
		continueGoogle: "Continue with Google",
		postAnon: "Write anonymously",
		or: "or",
		...
		errorTitle: "Something went wrong",
		loadError: "Couldn't load the messages. Please try again.",
		retry: "Retry",
		openIssue: "Open GitHub issue",
		validation: {
			name: "Enter your name",
			nameMax: "Max {max} characters",
			siteMax: "Max {max} characters",
			message: "Write your message",
			messageMax: "Max {max} characters",
			token: "Complete the verification below",
		},
	},
	...
	hero: {
		...
		talk: "Let's Talk",
		talkSr: "(Allow you to schedule a meeting with Rizki or send him an email)",
		talkMenu: {
			callLabel: "15-30 minute call",
			scheduleCall: "Schedule a call",
			scheduleCallSr: "(via cal.com)",
			asyncLabel: "Prefer async?",
