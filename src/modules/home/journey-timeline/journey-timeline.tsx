...
import setupMacbook from "@/assets/setup-macbook.webp?url";
import prepFlight from "@/assets/prep-flight.webp?url";
    ...
    content: (
      <div className="space-y-1.5">
        ...
        <JourneyTimelineParagraph>
          In late 2023, I began exploring new interests in crypto, web3, and
          cryptocurrency trading. I reached out to a friend who had been working
          in this field for years to learn how things worked and expand my
          knowledge into these emerging areas. By February 2024, I decided to
        ...
        <div className="grid grid-cols-5 gap-2.5">
          <JourneyImage
            ...
            alt="Rizki's setup a Macbook from company"
            title="Rizki's setup a Macbook from company"
          />
          <JourneyImage
            src={potrait}
            className="h-32 lg:h-44"
            containerClassName="col-span-2"
            alt="Rizki's potrait wearing Bitwyre T-shirt"
            title="Rizki's potrait wearing Bitwyre T-shirt"
          />
        </div>
        <JourneyTimelineParagraph>
          Coincidentally, the next day, a friend introduced me to Bitwyre , a
          company specializing in cryptocurrency, web3, and crypto trading. I
          applied immediately, went through interviews with their CTO and CEO,
          and was accepted as a Software Engineer (Frontend) on their
          Engineering team. It was fascinating how an area of personal interest
          became the field I now work in professionally.
        </JourneyTimelineParagraph>

        <JourneyTimelineParagraph>
          My first few months at Bitwyre involved adapting to a vastly different
          company culture. As a diverse organization with employees from around
          the world—Canada, America, India, Europe, and more—it was a unique
          environment. Despite English being my third language, it didn&apos;t
          hinder collaboration across continents.
        </JourneyTimelineParagraph>
        ...
        <div className="grid grid-cols-5 gap-2.5">
          <JourneyImage
            ...
            containerClassName="col-span-2"
            alt="Rizki's preparing to flight"
            title="Rizki's preparing to flight"
          />
          <JourneyImage
            src={coinfest1}
        ...
        <JourneyTimelineParagraph>
          In August 2024, the company attended Coinfest Asia , a crypto/web3
          event in Bali. Alongside the Engineering team, I joined the trip,
          combining work with a week-long stay that included a small internal
          hackathon at a villa. The event provided valuable connections,
          insights, and experiences, further solidifying my adaptability to the
        ...
        <div className="grid grid-cols-7 gap-2.5">
          <JourneyImage
            ...
            className="h-32 lg:h-44 object-top"
            containerClassName="col-span-2"
          ...
          <JourneyImage
            ...
            className="h-32 lg:h-44 object-bottom"
            containerClassName="col-span-3"
          ...
          <JourneyImage
            ...
            className="h-32 lg:h-44 object-bottom"
            containerClassName="col-span-2"
            alt="Rizki's graduation potrait with his girlfriend"
            title="Rizki's graduation potrait with his girlfriend"
          />
        ...
        <JourneyTimelineParagraph>
          By late 2024, I graduated from university, marking the end of a
          three-year journey. While the institution I attended may not compare
          in size or prestige to larger universities like Gadjah Mada or the
          University of Indonesia, the experience I gained was invaluable. Time
          flew by, and though the academic environment wasn’t overwhelming, it
          gave me the foundation to grow. This milestone reinforced my readiness
          to continue advancing in both my career and personal pursuits.
        </JourneyTimelineParagraph>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-1.5">
        ...
        <JourneyTimelineParagraph>
          In 2023, I continued working as a Frontend Developer at Skyshi Digital
          Indonesia. One of my notable projects was building{" "}
          <a
            target="_blank"
          ...
          for Moladin, which I completed in just around 5 weeks. Afterward, I
          was assigned to other confidential projects bound by NDAs, further
    ...
    content: (
      <div className="space-y-1.5">
        ...
        <JourneyTimelineParagraph>
          ...
          can&apos;t recall much, but I've been studying from home ever since.
        </JourneyTimelineParagraph>
      </div>
    ),
  },
