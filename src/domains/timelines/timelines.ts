...
export const timelines: CreateTimelinePayload = {
  titles: [
    ...
    'Contract Extended - Skyshi Digital Indonesia',
    "Let's see what the future holds for me.",
  ],
  emojis: ['LIFE', 'SCHOOL', 'SCHOOL', 'OTHER', 'CAREER', 'CAREER', 'CAREER', 'CURRENT_EVENT'],
  dates: [
    '- 2003',
    'May 2018',
    'November 2021',
  ...
  lists: [
    [
      'The world witnessed my birth and acknowledged my presence.',
      'And how fortunate I am to have been born into this exquisite world',
    ],
    [
    ...
    [
      'After doing a good job for the last three months, they hired me for a one-year contract as a frontend.',
      "While maintaining my campus activities, I'm doing the best I can to contribute to my job.",
    ],
    [
      "Im so grateful of what I've achieved for the last year.",
      'After a fantastic experience for the last year, they hired me for another one-year contract.',
    ],
    [
      "I'm still working at Skyshi Digital Indonesia.",
