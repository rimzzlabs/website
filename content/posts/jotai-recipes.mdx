...
export function composeAtom<T>(...fns: Array<ComposeAtomFn<T>>) {
  return (value: Atom<T>) => {
    return fns.reduce((acc, fun) => fun(value), value)
  }
}
```
...
export function openAtom(boolAtom: Atom<boolean>) {
  return atom(null, (_, set) => set(boolAtom, true))
}

export function closeAtom(boolAtom: Atom<boolean>) {
  return atom(null, (_, set) => set(boolAtom, false))
}

export function toggleAtom(boolAtom: Atom<boolean>) {
...
export function addAtom(numberAtom: Atom<number>) {
  return atom((get) => get(numberAtom) + 1)
}
export function multiplyAtom(numberAtom: Atom<number>) {
  return atom((get) => get(numberAtom) * 2)
}
export function divideAtom(numberAtom: Atom<number>) {
  return atom((get) => get(numberAtom) / 2)
}
export function minusAtom(numberAtom: Atom<number>) {
  return atom((get) => get(numberAtom) - 1)
}
```
...
```ts title="@/atoms/number.ts" showLineNumbers
export function formatNumberAtom(numberAtom: Atom<number>) {
  return atom((get) => {
